...
[![Project](https://img.shields.io/badge/Status-Active-brightgreen)](https://github.com/Rithikis14/aquathreat)
...
```bash
git clone [https://github.com/Rithikis14/aquathreat.git](https://github.com/Rithikis14/aquathreat.git)
cd aquathreat
```
